// frontend/js/registro/matriculas.js

window.Modules = window.Modules || {};

window.Modules.registroMatriculas = (function () {
    let matriculas = [];
    ...
    function configurarEventos() {
        const btnFiltrar = document.getElementById('btn-filtrar-registro-matriculas');
        const inputBuscar = document.getElementById('filtro-registro-matriculas');
        const selectEstado = document.getElementById('filtro-registro-estado-matricula');
    ...
    async function cargarMatriculas() {
        const tabla = document.getElementById('tabla-registro-matriculas');

        try {
            window.UI.clearMessage('registro-matriculas-message');
    ...
    function aplicarFiltros() {
        const texto = String(document.getElementById('filtro-registro-matriculas')?.value || '')
            .trim()
            .toLowerCase();

        const estado = String(document.getElementById('filtro-registro-estado-matricula')?.value || '')
            .trim()
            .toLowerCase();
    ...
    function renderResumen(data) {
        ...
        setText('registro-matriculas-total', total);
        setText('registro-matriculas-creditos', creditos);
        setText('registro-matriculas-monto', window.Helpers.formatCurrency(monto));
        setText('registro-matriculas-pendientes', pendientes);
    }
                ...
                <tr>
                    ...
                    <td>
                        <button
                            ...
                            onclick="window.Modules.registroMatriculas.ver(${Number(item.MatriculaID)})"
                        >
                            Ver
                        </button>
                    </td>
