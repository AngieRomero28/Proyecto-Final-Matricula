...
window.Modules.adminProgramas = (function () {
    let programas = [];
    ...
    function configurarEventos() {
        const btnFiltrar = document.getElementById('btn-filtrar-admin-programas');
        const inputBuscar = document.getElementById('filtro-admin-programa-buscar');
        const btnNuevo = document.getElementById('btn-admin-nuevo-programa');
    ...
    async function cargarProgramas() {
        const tabla = document.getElementById('tabla-admin-programas');
    ...
    function aplicarFiltros() {
        const texto = String(document.getElementById('filtro-admin-programa-buscar')?.value || '')
            .trim()
            .toLowerCase();
    ...
    function renderResumen() {
        ...
        setText('admin-programas-total', total);
        setText('admin-programas-estudiantes', totalEstudiantes);
        setText('admin-programas-promedio', promedio);
    }
    ...
    function renderTabla() {
        ...
        tabla.innerHTML = programasFiltrados.map((programa) => `
            <tr>
                ...
                <td>
                    <button class="btn btn-outline" onclick="window.Modules.adminProgramas.verDetalle(${programa.ProgramaAcademicoID || programa.ProgramaID})">
                        Ver
                    </button>
                </td>
            </tr>
