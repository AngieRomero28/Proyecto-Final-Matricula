...
window.Modules.adminAuditoria = (function () {
    let eventos = [];
    let filtrados = [];
    ...
    function configurarEventos() {
        const btnFiltrar = document.getElementById('btn-filtrar-admin-auditoria');
        const inputUsuario = document.getElementById('filtro-admin-usuario');
        const inputAccion = document.getElementById('filtro-admin-accion');
        const inputFecha = document.getElementById('filtro-admin-fecha');
    ...
    async function cargarAuditoria() {
        const tabla = document.getElementById('tabla-admin-auditoria');
    ...
    function aplicarFiltros() {
        const usuario = String(document.getElementById('filtro-admin-usuario')?.value || '')
            .trim()
            .toLowerCase();

        const accion = String(document.getElementById('filtro-admin-accion')?.value || '')
            .trim()
            .toLowerCase();

        const fecha = String(document.getElementById('filtro-admin-fecha')?.value || '').trim();
