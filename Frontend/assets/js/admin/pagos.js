...
window.Modules.adminPagos = (function () {
    let pagos = [];
    let pagosFiltrados = [];
    ...
    function configurarEventos() {
        const btnFiltrar = document.getElementById('btn-filtrar-admin-pagos');
        const inputBuscar = document.getElementById('filtro-admin-pagos');
        const selectEstado = document.getElementById('filtro-admin-estado-pago');
    ...
    async function cargarPagos() {
        const tabla = document.getElementById('tabla-admin-pagos');
    ...
    function aplicarFiltros() {
        const texto = String(document.getElementById('filtro-admin-pagos')?.value || '')
            .trim()
            .toLowerCase();

        const estado = String(document.getElementById('filtro-admin-estado-pago')?.value || '')
            .trim()
            .toLowerCase();
